...
<footer>
    <div class="container-fluid">
        <div class="row" style="background: #E55100; color: white;">
            <div class="col-xs-4"><h3>¿COMO COMPRAR?</h3></div>
            <div class="col-xs-4"><h3>NOSOTROS</h3></div>
            <div class="col-xs-2"><h3>GALER&Iacute;A</h3></div>
            <div class="col-xs-2"><h3>CONTACTANOS</h3></div>
        </div>
        <div class="row" style="color: white;">
            <div class="col-xs-4 footer-column-container">
                <ul>
            ...
            <div class="col-xs-2 footer-column-container">
